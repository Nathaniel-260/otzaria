...
class AppSurfaces {
  ...
  /// רקע כרטיסייה ברצועת החלונית.
  static Color paneTabChip(
    ColorScheme cs, {
    required bool isSelected,
    required bool isHovered,
  }) {
    if (isSelected) return cs.surfaceContainerHighest;
    if (isHovered) return cs.onSurface.withValues(alpha: 0.06);
