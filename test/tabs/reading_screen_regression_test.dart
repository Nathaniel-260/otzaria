...
void main() {
  ...
  group('reading_screen — שוליים חיצוניים בתצוגה זה-לצד-זה', () {
    ...
    // כרטיס החלונית עצמו צמוד לדופן עד כדי שוליו הדקים, כך שידית הפתיחה
    // (Positioned(left:0)) נשארת על הדופן ולא נדחקת פנימה עם הטקסט.
    ...
    testWidgets(
      'ReadingScreen עם CombinedTab: הכרטיסים על הדופן והתוכן נשמר 12px פנימה',
      (tester) async {
